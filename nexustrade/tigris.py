...
LAKE_CATALOG: dict[str, LakeDataset] = {
    ...
    "insider_filings": _ds(
        ...
        "SEC Form 3/4/5 filings, one row per reporting owner. Point-in-time: filter availableAt. "
        "EDGAR page: https://www.sec.gov/Archives/edgar/data/{int(issuerCik)}/{accession without dashes}/{accession}-index.htm",
    ),
    "insider_transactions": _ds(
